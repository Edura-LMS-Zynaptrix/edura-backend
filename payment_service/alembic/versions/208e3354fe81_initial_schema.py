...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "receipt_status",
            sa.Enum("PENDING", "APPROVED", "REJECTED", name="receiptstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_payment_receipts_payment_id",
        "payment_receipts",
        ["payment_id"],
        unique=False,
    )
    op.create_index(
        "ix_payment_receipts_student_id",
        "payment_receipts",
        ["student_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "payment_method",
            sa.Enum("MANUAL", "PAYHERE", name="paymentmethod"),
            nullable=False,
        ),
        sa.Column(
            "payment_status",
    ...
    op.create_index(
        op.f("ix_payments_reference_no"), "payments", ["reference_no"], unique=False
    )
