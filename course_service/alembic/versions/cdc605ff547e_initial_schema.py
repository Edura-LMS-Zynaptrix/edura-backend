...
def upgrade() -> None:
    ...
    sa.Column('course_type', sa.Enum('video', 'exam', name='coursetype'), nullable=False),
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('lesson_type', sa.Enum('video', 'document', 'quiz', name='lessontype'), nullable=False),
