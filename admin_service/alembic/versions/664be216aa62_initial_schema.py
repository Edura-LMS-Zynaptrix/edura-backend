...
def upgrade() -> None:
    ...
    sa.Column('action', sa.Enum('user_created', 'user_deactivated', 'user_role_changed', 'receipt_approved', 'receipt_rejected', 'course_published', 'course_unpublished', 'course_deleted', 'enrollment_revoked', 'settings_updated', 'other', name='auditaction'), nullable=False),
